...
PROMPT_VERSION = "feedback-prompt-v0.7.0"
SCHEMA_VERSION = "structured-feedback-v0.7.0"
SYSTEM_TEMPLATE_PATH = Path(__file__).with_name("system_prompt_v0_7_0.txt")
PROMPT_MANIFEST_PATH = Path(__file__).with_name("prompt_manifest_v0_7_0.json")

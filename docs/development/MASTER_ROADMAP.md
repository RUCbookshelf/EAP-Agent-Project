...
“Cloud-ready” means separable interfaces and configuration; it does not mean cloud deployment. v0.4–v0.6 are labels only and have no implementation authorization.

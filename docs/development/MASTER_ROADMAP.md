...
| Item | Current value |
|---|---|
| Current project version | 0.5.0 (development) |
...
| v0.5 status | in_progress |
| v0.6 status | not_started |
| v0.3 implementation commit | `0ce8f1a` |
| Database migration version | 4 |
| Prompt version | `feedback-prompt-v0.4.0` |
| Feedback Schema version | `structured-feedback-v0.1.1` |
| API version | v1 |
| Current blocker | none |
| Next step | Complete the v0.5 acceptance gate, then continue automatically to v0.6 |
...
- v0.5 — Revision-aware Feedback: `in_progress`
- v0.6 — Progress Visualization and Versioned Configuration: `not_started`

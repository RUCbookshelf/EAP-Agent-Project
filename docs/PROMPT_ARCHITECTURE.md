...
- `app/prompts/system_prompt_v0_1_1.txt`：纳入版本管理的固定 System Prompt。
- `app/prompts/builder.py`：把 `FeedbackContext` 渲染为 messages，并构造一次纠错 Prompt。
- `app/prompts/versioning.py`：`feedback-prompt-v0.1.1`、`structured-feedback-v0.1.1` 和 SHA-256。
- `app/prompts/prompt_manifest_v0_1_1.json`：冻结模板文件、Prompt/Schema 版本及 System/User 模板哈希。

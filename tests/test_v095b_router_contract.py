...
EXPECTED_ROUTE_CONTRACT = {
    # Reconciled by PDW3-WU5-INT-CONSOLIDATED-WAVE3-INTEGRATION-GATE:
    # 112 = 80 INT-baseline + 20 promoted master + 2 approved Journey
    # projections + 2 LEARNER WU2 acknowledgement routes + 8 L2 WU3
    # adaptive-practice/Tutor routes; provenance:
    # verification/pdw3-wu5-int-consolidated-wave3-integration-gate/route_census.json.
    ...
    ('GET', '/api/v1/wave2/revision/tasks/{task_id}/versions/{submission_id}/observation'),
    ('GET', '/docs'),
    ...
    ('POST', '/api/v1/wave2/revision/tasks/{task_id}/submissions/{submission_id}/revisions'),

"""v0.9.4-B Student lifecycle/recovery verification (log-file stack, isolated DB).
...
Run: python verification/v0.9.4-b/v0.9.4-b-20260801-r1/lifecycle_check.py
"""
...
from v094b_harness import (  # noqa: E402
    BASE,
    UI,
    prepare_isolated_db,
    select_page,
...
def main() -> int:
    ...
    try:
        ...
        with sync_playwright() as pw:
            ...
            learner.fill("EMPTY01")
            learner.press("Enter")
            wait_stable(page, expected="[data-testid='stAppViewContainer']")
            select_page(page, "Practice", "Practice")
